describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
        ...
        cy.get('input[type="email"]').type('gongadze.leo@yandex.ru');                   // вводим логин
        cy.get('input[type="password"]').type('AnLe!!!9194');               // вводим пароль
        ...
        cy.get('.credit').type('4003600000000014');                     // вводим номер карты
